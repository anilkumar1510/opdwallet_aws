...
/** Step 3: who is this vaccination for. */
@Component({
  selector: 'opd-vaccination-patient-page',
      ...
      >
        <div class="mx-auto flex max-w-[900px] items-center gap-4 px-5 py-5 lg:px-8">
          ...
          <div class="min-w-0">
            ...
            <p class="truncate text-[12px] leading-[1.2] text-white/80 lg:text-sm lg:text-ink-500">Who is this vaccination for?</p>
          </div>
        </div>
      </header>
...
export class VaccinationPatientPage {
