...
import { ChevronLeftIcon, HeartIcon, CalendarIcon, ClockIcon, CheckCircleIcon } from '@heroicons/react/24/outline'
...
export default function DiagnosticBookingPage() {
  ...
  const getTotalAmount = () => {
    ...
    return selectedVendor.totalDiscountedPrice
  }
  ...
  const handlePaymentSuccess = async (transaction: any) => {
    console.log('[DiagnosticBooking] Payment successful, creating order')
    ...
    try {
      ...
      console.log('[DiagnosticBooking] Creating order with payment already processed')

      const response = await apiClient.post('/member/diagnostics/orders', bookingData)
      console.log('[DiagnosticBooking] Order created successfully:', response.data)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4 max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm mb-4">
          <h3 className="font-semibold text-gray-900 mb-2">Services in Cart</h3>
        ...
        {step === 1 && (
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-900">Select Diagnostic Vendor</h2>
              ...
              vendors.map((vendor) => (
                ...
                >
                  ...
                  <div className="border-t border-gray-100 pt-3">
                    <div className="text-xs text-gray-600 mb-2">Service Pricing:</div>
          ...
          <div className="space-y-4">
            ...
            {!validating && userId && validationResult?.valid && (
              <PaymentProcessor
                ...
                serviceDetails={{
                  doctorName: selectedVendor.name || 'Diagnostic Service',
                  clinicId: selectedVendor.vendorId || '',
                  clinicName: selectedVendor.name || '',
                  serviceCode: cart.cartId,  // Just pass cartId, all diagnostic orders are center visits
                ...
                onPaymentFailure={(error) => {
                  console.error('[DiagnosticBooking] Payment failed:', error)
