...
// When user requests /operations, middleware sees /
// When user requests /operations/members, middleware sees /members

// Protected routes that require authentication (WITHOUT base path prefix)
const protectedRoutes = [
  '/',  // Dashboard (maps to /operations)
  '/members',
  '/doctors',
  '/clinics',
  '/appointments',
...
const allowedRoles = ['OPS_ADMIN', 'OPS_USER']
