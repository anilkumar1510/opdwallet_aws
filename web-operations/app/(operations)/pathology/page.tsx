...
export default function LabDashboardPage() {
  ...
  const quickActions = [
    {
      ...
      description: 'Manage pathology test services and categories',
      icon: BeakerIcon,
    ...
    },
    {
      ...
      path: '/pathology/master-tests',
      color: 'bg-green-50 hover:bg-green-100 border-green-200',
      stats: 'Test catalog',
    },
    {
      name: 'Pathology Vendors',
      description: 'Manage pathology vendors, pricing, and slots',
      icon: BuildingStorefrontIcon,
      path: '/pathology/vendors',
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="stat-card">
          <div className="flex items-center justify-between">
            <div>
              <p className="stat-label">Pathology Services</p>
        ...
        <div className="stat-card">
          <div className="flex items-center justify-between">
            <div>
              <p className="stat-label">Pathology Vendors</p>
          ...
          <div className="stat-change-positive">
            <span>Partner pathology vendors</span>
          </div>
        </div>
      ...
      {/* Quick Actions */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Pathology Management</h3>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Pathology Overview</h3>
        </div>
        <div className="space-y-3 text-sm text-gray-600">
          <p>
            <strong className="text-gray-900">Pathology Services:</strong> Manage the catalog of available
            pathology test services.
          </p>
          <p>
            <strong className="text-gray-900">Pathology Vendors:</strong> Configure partner pathology labs with
