    ...
    <div className="min-h-screen flex">
      <div className="w-full lg:w-1/2 flex flex-col bg-gray-50">
        <div style={{ backgroundColor: '#1E4A8D' }} className="w-full py-4 px-6">
          <img
            src="/finance/logos/habit-logo-white.png"
            alt="Habit Health - Finance Portal"
          ...
          <div className="w-full max-w-md">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Sign in to manage payments and finances
              </p>
            </div>
          ...
          <div className="text-white max-w-lg w-full">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl backdrop-blur-lg border border-white/30" style={{ backgroundColor: 'rgba(255,255,255,0.2)' }}>
                <h3 className="text-white font-bold text-lg mb-2">Payment Processing</h3>
                <p className="text-white/90 text-sm">Manage pending payments and transactions</p>
              </div>

              <div className="p-4 rounded-xl backdrop-blur-lg border border-white/30" style={{ backgroundColor: 'rgba(255,255,255,0.2)' }}>
                <h3 className="text-white font-bold text-lg mb-2">Financial Reports</h3>
                <p className="text-white/90 text-sm">Track revenue and financial analytics</p>
              </div>

              <div className="p-4 rounded-xl backdrop-blur-lg border border-white/30" style={{ backgroundColor: 'rgba(255,255,255,0.2)' }}>
                <h3 className="text-white font-bold text-lg mb-2">Claims & Reconciliation</h3>
                <p className="text-white/90 text-sm">Reconcile claims with insurance partners</p>
              </div>
            </div>
          </div>
        </div>
