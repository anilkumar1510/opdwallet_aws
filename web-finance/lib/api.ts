...
export function apiUrl(path: string): string {
  ...
  // With basePath: '/finance', we need to prepend it to API calls for rewrites to work
  // In browser, window.location will include /finance, so we extract and prepend it
  if (typeof window !== 'undefined') {
    const basePath = '/finance'; // Match next.config.js basePath
