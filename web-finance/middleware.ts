...
// When user requests /finance, middleware sees /
// When user requests /finance/payments, middleware sees /payments

// Protected routes that require authentication (WITHOUT base path prefix)
const protectedRoutes = [
  '/',  // Dashboard (maps to /finance)
  '/pending-payments',
  '/payment-history',
]
...
const allowedRoles = ['FINANCE_ADMIN', 'FINANCE_USER']
