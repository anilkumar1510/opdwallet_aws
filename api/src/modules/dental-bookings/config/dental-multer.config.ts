...
const DESTINATION = './uploads/dental-prescriptions';

/**
 * The prescription the dentist hands over at the visit — flow 4 step 15.
 *
 ...
 */
export const dentalPrescriptionMulterConfig = {
  storage: diskStorage({
