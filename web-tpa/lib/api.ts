...
export function apiUrl(path: string): string {
  ...
  // With basePath: '/tpa', we need to prepend it to API calls for rewrites to work
  // In browser, window.location will include /tpa, so we extract and prepend it
  if (typeof window !== 'undefined') {
    const basePath = '/tpa'; // Match next.config.js basePath
