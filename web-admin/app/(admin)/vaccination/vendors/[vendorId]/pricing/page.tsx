...
export default function VaccinationVendorPricingPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Fetch vendor
      const vendorRes = await apiFetch('/api/admin/vaccination/vendors')
      if (vendorRes.ok) {
      ...
      // Fetch pricing
      const pricingRes = await apiFetch(`/api/admin/vaccination/vendors/${vendorId}/pricing`)
      if (pricingRes.ok) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = editingPricing
        ? `/api/admin/vaccination/vendors/${vendorId}/pricing/${formData.serviceId}`
        : `/api/admin/vaccination/vendors/${vendorId}/pricing`
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Modal - No home collection charges for vaccination */}
      {showModal && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> Vaccination is center visit only. No home collection charges apply.
                </p>
              </div>
