  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Radiology Vendors</h1>
          <p className="text-sm text-gray-600 mt-1">Manage radiology imaging & testing partner vendors</p>
        </div>
        <button
          onClick={() => {
            setEditingVendor(null)
                ...
                <div key={vendor._id} className="p-6 hover:bg-gray-50 transition-colors">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex space-x-2 ml-4">
                      ...
                      <button
                        onClick={() => router.push(`/radiology/vendors/${vendor.vendorId}/pricing`)}
                      ...
                      <button
                        onClick={() => router.push(`/radiology/vendors/${vendor.vendorId}/slots`)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
          <div className="bg-white rounded-lg p-6 w-full max-w-3xl my-8">
            <h2 className="text-xl font-bold mb-4">
              {editingVendor ? 'Edit Radiology Vendor' : 'Add New Radiology Vendor'}
            </h2>
