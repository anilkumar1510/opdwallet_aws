...
export default function LabServicesPage() {
  ...
  const categories = ['PATHOLOGY', 'OTHER']
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Pathology Services</h1>
          <p className="text-sm text-gray-600 mt-1">Manage pathology test services</p>
        </div>
        <button
          onClick={() => {
            setEditingService(null)
