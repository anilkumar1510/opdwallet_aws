...
function PoliciesContent() {
  ...
  // Parse query params from URL (memoized to prevent infinite re-renders)
  const queryParams = useMemo<PolicyQueryParams>(() => ({
    ...getDefaultParams(),
