  ...
  const fetchAppointments = useCallback(async (targetUserId: string) => {
    try {
      ...
      const response = await apiClient.get<Appointment[]>(
        `/appointments?userId=${targetUserId}&type=ONLINE`
      );
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#f7f7fc' }}>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={handleRefresh} colors={['#0F5FDC']} />
        }
      >
        <View style={{ maxWidth: 480, marginHorizontal: 'auto', width: '100%' }}>
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 18, fontWeight: '700', color: '#0E51A2', marginBottom: 4 }}>
            ...
            <View style={{ gap: 10, marginBottom: 20 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                <CheckCircleIcon width={18} height={18} color="#25A425" />
                <Text style={{ fontSize: 14, color: '#374151' }}>Available 24/7 for immediate consultation</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                <CheckCircleIcon width={18} height={18} color="#25A425" />
                <Text style={{ fontSize: 14, color: '#374151' }}>Voice or video call support</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                <CheckCircleIcon width={18} height={18} color="#25A425" />
                <Text style={{ fontSize: 14, color: '#374151' }}>Get prescriptions digitally</Text>
              </View>
            </View>

            {/* CTA Button */}
            <TouchableOpacity onPress={handleConsultNow} activeOpacity={0.8}>
              <LinearGradient
          ...
          {appointments.length === 0 ? (
            ...
            <View style={{ gap: 16 }}>
              <Text style={{ fontSize: 12, fontWeight: '700', color: '#0E51A2', textTransform: 'uppercase', letterSpacing: 0.5 }}>
                ...
                >
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 16 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1 }}>
                      ...
                      <View style={{ flex: 1 }}>
                        <Text style={{ fontSize: 16, fontWeight: '700', color: '#0E51A2' }} numberOfLines={1}>
                  ...
                  >
                    <View style={{ gap: 12 }}>
                      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                        <UserIcon width={16} height={16} color="#0F5FDC" />
                        <Text style={{ fontSize: 13, color: '#6B7280' }}>Patient:</Text>
                        <Text style={{ fontSize: 13, fontWeight: '500', color: '#0E51A2', flex: 1 }} numberOfLines={1}>
                      ...
                      {appointment.contactNumber && (
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                          <PhoneIcon width={16} height={16} color="#0F5FDC" />
                          <Text style={{ fontSize: 13, color: '#6B7280' }}>Contact:</Text>
                          <Text style={{ fontSize: 13, fontWeight: '500', color: '#0E51A2' }}>
                            {appointment.contactNumber}
                          </Text>
                        </View>
                      ...
                      {appointment.callPreference && (
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                          <VideoCameraIcon width={16} height={16} color="#0F5FDC" />
                          <Text style={{ fontSize: 13, color: '#6B7280' }}>Mode:</Text>
                          <Text style={{ fontSize: 13, fontWeight: '500', color: '#0E51A2' }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, paddingHorizontal: 4 }}>
                    <Text style={{ fontSize: 12, color: '#6B7280' }}>
                      ID: <Text style={{ fontWeight: '600', color: '#0E51A2' }}>{appointment.appointmentId}</Text>
                    </Text>
                  ...
                  {appointment.hasPrescription && (
                    ...
                    >
                      <CheckCircleIcon width={16} height={16} color="#25A425" />
          ...
          >
            <Text style={{ fontSize: 16, fontWeight: '700', color: '#0E51A2', marginBottom: 16 }}>
              How it works
            </Text>
            <View style={{ gap: 12 }}>
              <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 8 }}>
                <Text style={{ fontSize: 14, fontWeight: '700', color: '#0F5FDC' }}>1.</Text>
                <Text style={{ fontSize: 14, color: '#374151', flex: 1 }}>Select your medical specialty</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 8 }}>
                <Text style={{ fontSize: 14, fontWeight: '700', color: '#0F5FDC' }}>2.</Text>
                <Text style={{ fontSize: 14, color: '#374151', flex: 1 }}>Choose an available doctor</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 8 }}>
                <Text style={{ fontSize: 14, fontWeight: '700', color: '#0F5FDC' }}>3.</Text>
                <Text style={{ fontSize: 14, color: '#374151', flex: 1 }}>Consult now or schedule for later</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 8 }}>
                <Text style={{ fontSize: 14, fontWeight: '700', color: '#0F5FDC' }}>4.</Text>
                <Text style={{ fontSize: 14, color: '#374151', flex: 1 }}>Connect via voice or video call</Text>
              </View>
            </View>
          </View>
        </View>
