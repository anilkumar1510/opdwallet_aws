  ...
  if (!cart) {
    return (
      <View style={{ flex: 1, backgroundColor: COLORS.background, justifyContent: 'center', alignItems: 'center', padding: 16 }}>
        ...
        <TouchableOpacity
          onPress={() => router.push('/member/pathology-lab' as any)}
          activeOpacity={0.8}
          style={{
    ...
    <View style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      >
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', maxWidth: 320, marginHorizontal: 'auto', width: '100%' }}>
          ...
          {/* Line 1-2 */}
          <View style={{ flex: 1, height: 4, backgroundColor: step >= 2 ? COLORS.primary : COLORS.border, marginHorizontal: 8, marginBottom: 20 }} />
          ...
          {/* Line 2-3 */}
          <View style={{ flex: 1, height: 4, backgroundColor: step >= 3 ? COLORS.primary : COLORS.border, marginHorizontal: 8, marginBottom: 20 }} />
      ...
      >
        <View style={{ maxWidth: 480, marginHorizontal: 'auto', width: '100%', gap: 16 }}>
          ...
          >
            <Text style={{ fontSize: 16, fontWeight: '600', color: COLORS.primary, marginBottom: 12 }}>Tests in Cart</Text>
            <View style={{ gap: 8 }}>
              {cart.items.map((item, idx) => (
                <View key={idx} style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                  <BeakerIcon width={16} height={16} color={COLORS.primary} />
                  <Text style={{ fontSize: 13, color: COLORS.textDark }}>{item.serviceName}</Text>
                </View>
              ))}
            </View>
          </View>
          ...
          {step === 1 && (
            <View style={{ gap: 16 }}>
              <Text style={{ fontSize: 18, fontWeight: '600', color: COLORS.primary }}>Select Lab Vendor</Text>
                ...
                vendors.map((vendor) => (
                  ...
                  >
                    ...
                    <View style={{ borderTopWidth: 1, borderTopColor: COLORS.border, paddingTop: 12 }}>
                      <Text style={{ fontSize: 12, fontWeight: '500', color: COLORS.textDark, marginBottom: 8 }}>Test Pricing:</Text>
            ...
            <View style={{ gap: 16 }}>
              ...
              >
                ...
                <View style={{ marginBottom: 20 }}>
                  <Text style={{ fontSize: 13, fontWeight: '500', color: COLORS.textDark, marginBottom: 12 }}>Collection Type</Text>
                    ...
                    >
                      <View
                        style={{
                          ...
                          borderRadius: 12,
                          borderWidth: 2,
                          borderColor: collectionType === 'IN_CLINIC' ? COLORS.selectedBorder : COLORS.border,
                          backgroundColor: collectionType === 'IN_CLINIC' ? 'rgba(3, 77, 162, 0.05)' : 'transparent',
                          alignItems: 'center',
                        }}
                      >
                        <BuildingOfficeIcon width={28} height={28} color={COLORS.primary} />
                        <Text style={{ fontSize: 13, fontWeight: '500', color: COLORS.primary, marginTop: 8 }}>Lab Visit</Text>
                    ...
                    >
                      <View
                        style={{
                          ...
                          backgroundColor: collectionType === 'HOME_COLLECTION' ? 'rgba(3, 77, 162, 0.05)' : 'transparent',
                          alignItems: 'center',
                        }}
                      >
                        <HomeIcon width={28} height={28} color={COLORS.primary} />
                        <Text style={{ fontSize: 13, fontWeight: '500', color: COLORS.primary, marginTop: 8 }}>Home Collection</Text>
                        <Text style={{ fontSize: 11, color: COLORS.textGray, textAlign: 'center', marginTop: 2 }}>
                ...
                {/* Date Selection */}
                <View style={{ marginBottom: 20 }}>
                  <Text style={{ fontSize: 13, fontWeight: '500', color: COLORS.textDark, marginBottom: 12 }}>Select Date</Text>
                        ...
                        >
                          <View
                            style={{
                              ...
                              backgroundColor: selectedDate === date.value ? 'rgba(3, 77, 162, 0.05)' : 'transparent',
                              alignItems: 'center',
                            }}
                          >
                            ...
                            <Text
                              style={{
                                fontSize: 18,
                                fontWeight: '600',
                                color: selectedDate === date.value ? COLORS.primary : COLORS.primaryLight,
                                marginVertical: 2,
                              }}
                            >
                              {date.dateNum}
                ...
                {selectedDate && (
                  <View>
                    <Text style={{ fontSize: 13, fontWeight: '500', color: COLORS.textDark, marginBottom: 12 }}>Select Time Slot</Text>
                            ...
                            >
                              <View
                                style={{
                                  ...
                                  borderRadius: 8,
                                  borderWidth: 2,
                                  borderColor: isSelected ? COLORS.selectedBorder : isAvailable ? COLORS.border : '#e5e7eb',
                                  backgroundColor: isSelected ? 'rgba(3, 77, 162, 0.05)' : isAvailable ? 'transparent' : '#f3f4f6',
                ...
                {validating ? (
                  ...
                  <View style={{ gap: 12 }}>
                    ...
                    {collectionType === 'HOME_COLLECTION' && (
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Text style={{ fontSize: 14, color: COLORS.textGray }}>Home Collection Charges</Text>
                        <Text style={{ fontSize: 14, fontWeight: '500', color: COLORS.textDark }}>
                          ₹{selectedVendor.homeCollectionCharges || 100}
                        </Text>
                      </View>
